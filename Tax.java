...
public class Tax {
    ...
    protected int getFilingStatus() {
        ...
        System.out.print(filingKey);
        return filingKey;
    }

    protected double calculateSalary(double hourlyWage, double hours) {
        salary = hourlyWage * hours * 52;
        System.out.println("\nYour calculated salary is about $" + salary + ".");
        return salary;
    }
    protected double calculateIncomeTax(int filingKey, double salary) {
        ...
        System.out.println("Your income tax is about " + showTax + "%.");
        return incomeTax;
    }
